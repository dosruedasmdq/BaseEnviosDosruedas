...
import { FastForward, MapPin, Package, Search } from "lucide-react";
  ...
  return (
    <section className="relative w-full py-12 md:py-24 lg:py-32 overflow-hidden bg-background">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          <div className="space-y-8 text-center lg:text-left">
            <div className="space-y-4">
              ...
              <p className="max-w-150 text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed mx-auto lg:mx-0 font-body font-light">
          ...
          <div className="relative aspect-square lg:aspect-auto lg:h-150 rounded-3xl overflow-hidden shadow-2xl rotate-2">
             {heroImage && (
                <Image
      ...
      <div className="absolute top-0 right-0 z-0 opacity-10 pointer-events-none">
        <div className="w-200 h-200 rounded-full bg-secondary blur-3xl transform translate-x-1/2 -translate-y-1/2" />
      </div>
    </section>
  );
}
