        ...
        <div className="grid gap-12 lg:grid-cols-4">
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-headline text-3xl tracking-tighter uppercase">
          ...
          <div className="space-y-6">
            <h4 className="font-headline text-xl uppercase tracking-wider text-secondary">Empresa</h4>
          ...
          <div className="space-y-6">
            <h4 className="font-headline text-xl uppercase tracking-wider text-secondary">Servicios</h4>
            <ul className="space-y-4 text-sm font-body text-primary-foreground/70">
          ...
          <div className="space-y-6">
            <h4 className="font-headline text-xl uppercase tracking-wider text-secondary">Contacto</h4>
            <ul className="space-y-4 text-sm font-body text-primary-foreground/70">
